...
const GRAMMAR_NOTES = {
  ...
  'grande':            '💡 <b dir="ltr">grande</b> = نوع ثانٍ من الصفات | لا يتغير بين مذكر ومؤنث، لكن الجمع: <b dir="ltr">grandi</b>',
...
const VERB_COMPLEMENTS = {
  ...
  'guardare':  [{s:'la TV.',as:'التلفاز'},{s:'un film.',as:'فيلماً'},{s:'il cellulare.',as:'الموبايل'},{s:'la partita.',as:'المباراة'},{s:'fuori.',as:'خارجاً'},{s:'con la famiglia.',as:'مع العائلة'},{s:'spesso.',as:'كثيراً'},{s:'la sorella.',as:'الأخت'}],
  ...
  'ascoltare': [{s:'musica.',as:'للموسيقى'},{s:'la radio.',as:'الراديو'},{s:'il professore.',as:'الأستاذ'},{s:'la madre.',as:'الأم'},{s:'una canzone.',as:'أغنية'},{s:'spesso.',as:'كثيراً'},{s:'bene.',as:'جيداً'},{s:'con attenzione.',as:'باهتمام'}],
  ...
  'passare':   [{s:'il tempo.',as:'الوقت'},{s:'il fine settimana.',as:'عطلة نهاية الأسبوع'},{s:'le vacanze in Italia.',as:'العطلة في إيطاليا'},{s:'la sera a casa.',as:'المساء في المنزل'},{s:'il pomeriggio.',as:'بعد الظهر'},{s:'bene.',as:'جيداً'},{s:'con gli amici.',as:'مع الأصدقاء'},{s:'la mattina.',as:'الصباح'}],
  'diventare': [{s:'famoso.',as:'مشهوراً'},{s:'grande.',as:'كبيراً'},{s:'medico.',as:'طبيباً'},{s:'professore.',as:'أستاذاً'},{s:'bravo.',as:'بارعاً'},{s:'importante.',as:'مهماً'},{s:'presto.',as:'قريباً'},{s:'un campione.',as:'بطلاً'}],
  ...
  'aspettare':  [{s:"l'autobus.",as:'الأتوبيس'},{s:'il treno.',as:'القطار'},{s:'gli amici.',as:'الأصدقاء'},{s:'la famiglia.',as:'العائلة'},{s:'tanto.',as:'طويلاً'},{s:'in silenzio.',as:'بصمت'},{s:'fuori.',as:'بالخارج'},{s:'ancora.',as:'مجدداً'}],
...
const data={
  ...
  verbs:{
    regular:[
      ...
      {it:'nascere',   ar:'يولد',    arPast:'وُلد',  arPres:['أولد','تولد','يولد/تولد','نولد','تولدون','يولدون'],          s:'in Italia.',       as:'في إيطاليا',    aux:'essere', pastPart:'nato'},
      ...
      {it:'ricevere',  ar:'يستلم',   arPast:'استلم', arPres:['أستلم','تستلم','يستلم/تستلم','نستلم','تستلمون','يستلمون'],                   s:'un messaggio.',   as:'رسالة',         aux:'avere', pastPart:'ricevuto'},
      ...
      {it:'insegnare', ar:'يعلّم',   arPast:'علّم',   arPres:['أعلِّم','تُعلِّم','يعلِّم/تُعلِّم','نُعلِّم','تُعلِّمون','يُعلِّمون'],                            s:'italiano.',       as:'الإيطالية',     aux:'avere'},
    ...
    irregular:[
      ...
      {it:'rimanere', ar:'يظل',       arPast:'ظل',   arPres:['أظل','تظل','يظل/تظل','نظل','تظلون','يظلون'],                         s:'a casa.',        as:'في المنزل',    aux:'essere', pastPart:'rimasto'},
      {it:'vivere',   ar:'يعيش',      arPast:'عاش',  arPastRoot:'عش', arPres:['أعيش','تعيش','يعيش/تعيش','نعيش','تعيشون','يعيشون'],                     s:'a Milano.',      as:'في ميلانو',    aux:'avere',  pastPart:'vissuto'},
      {it:'stare',    ar:'يكون بخير', arPast:'كان',  arPastRoot:'كن', arPres:['أكون','تكون','يكون/تكون','نكون','تكونون','يكونون'],                      s:'bene.',          as:'بخير',         aux:'essere'},
      ...
      {it:'potere',   ar:'يستطيع',    arPast:'استطاع',arPastRoot:'استطع', arPres:['أستطيع','تستطيع','يستطيع/تستطيع','نستطيع','تستطيعون','يستطيعون'],                      s:'venire.',        as:'أن يأتي',      aux:'avere', pastPart:'potuto'},
      {it:'dovere',   ar:'يجب',       arPast:'وجب',  arPres:['يجب عليّ','يجب عليك','يجب عليه/عليها','يجب علينا','يجب عليكم','يجب عليهم'],                         s:'lavorare.',      as:'أن يعمل',      aux:'avere', pastPart:'dovuto'},
